using MarketplaceSystem.Web.UI.Admin.Extensions;
using MarketplaceSystem.Web.UI.Admin.Interfaces.IBaseServices;
using System.Text;
using System.Text.Json;

namespace MarketplaceSystem.Web.UI.Admin.Services.BaseServices
{
    public class BaseApiService : IBaseApiService
    {
        ...
        public virtual async Task<HttpResponseMessage?> PostFileAsync(
            string endpoint,
            Stream fileStream,
            string fileName,
